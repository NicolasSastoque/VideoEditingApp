        ...
        <div className="container flex h-14 items-center max-lg:px-5">
            ...
            <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
                <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                    <ul className="w-full flex justify-between items-center gap-x-8 max-lg:block max-lg:px-12">
                        <li className="nav-li">
            ...
            <button className='lg:hidden z-2 size-10 border-2 border-s4/s5 rounded-full flex justify-center items-center' onClick={() => setIsOpen(prevState => !prevState)} >
